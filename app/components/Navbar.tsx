        ...
        {navbar.map((item) => (
          ...
          >
            <span>{item.name}</span>
              ...
              <Link href='https://drive.google.com/file/d/142yYdDYVt1uuPfQO1mk6dJSg_C4NyMnP/view?usp=drive_link' target='_blank' className="bg-black/20 py-2 px-4 rounded hover:bg-black/50 transition-all font-medium cursor-pointer text-lg">Resume</Link>
      </div>
    </div>
  );
};
