      ...
      <>
          <motion.div animate={showMenu ? 'show' : 'hide'} variants={{
              ...
              {navbar.map((nav) => (
                ...
                <Link href='https://drive.google.com/file/d/1j9A_WgQTJqLDIhAi5UiNb6r8qTJeMG24/view?usp=drive_link' target='_blank' className="bg-black/30 w-full text-center font-semibold text-color-text py-3 px-4 rounded cursor-pointer">Resume</Link>
