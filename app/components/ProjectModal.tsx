  ...
  return (
      <div className='fixed inset-0 bg-black/40 flex flex-row items-center justify-center z-[99]'>
          <div className='lg:w-2/3 bg-color-panel p-4 rounded flex flex-col items-center relative gap-4 xs:h-5/6 xs:overflow-y-auto lg:h-auto lg:overflow-visible xs:w-5/6 '>
              ...
              <div className='flex flex-row items-center gap-3 text-white bg-black/50 py-2 px-3 w-full whitespace-break-spaces justify-center rounded xs:text-sm lg:text-base'>
                  <FaGlobe/>
                  <Link className='underline text-blue-600 xs:line-clamp-1 lg:line-clamp-3' target='_blank' href={project.deployedLink}>{project.deployedLink} </Link>
              </div>
              <div className='flex flex-row items-center gap-3 text-white bg-black/50  py-2 px-3 w-full justify-center rounded xs:text-sm lg:text-base'>
                  <FaGithub />
                    <Link className='underline text-blue-600 xs:line-clamp-1 lg:line-clamp-3' target='_blank' href={project.githubLink}>{project.githubLink} </Link>
              </div>
          </div>
