      ...
      <div className='bg-white/10 rounded w-full flex flex-col gap-8 p-4'>
          ...
          <div className='flex flex-row items-center py-3 px-4 rounded  bg-black/40  gap-6 xs:justify-center lg:justify-start '>
              {profiles.map((profile) => {
                  return  <Link  key={profile.name} href={profile.profile} className='lg:h-24 lg:w-24 xs:w-12 xs:h-12 bg-blue-600/10 p-2 rounded outline outline-1 outline-white hover:scale-105 transition duration-300 hover:bg-blue-600/30'>
