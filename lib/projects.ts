...
export const projects: Project[] = [
 ...
 
  {
    ...
    description:
      "ResourceHub is a dynamic platform empowering tech enthusiasts to share DSA sheets and tech guidance. Users enhance learning with categorized solutions and engage in discussions. Task-centric resources guide sequential learning, supplemented with rich media. A virtual leaderboard adds competition using ResourceHub's currency. Continuous improvement is prioritized, welcoming valuable user suggestions. 🌐💻",
  ...
  },
  {
    ...
    description:
      "LegalEase is a platform that connects lawyers and clients. It allows lawyers to create and manage their profiles. It also allows clients to create and manage their cases. It also has a chat feature that allows lawyers and clients to chat with each other.",
  ...
  },
  {
    ...
    },
    {
        ...
        description:
          "A basic social media app built using React, Firebase, and Tailwind CSS. It allows users to create posts, like posts, and comment on posts. It also has a login and signup page.",
      ...
      },
      {
        ...
        description:
          "A sound maker app built using HTML, CSS, and JavaScript. It allows users to play different sounds by clicking on the buttons.",
      ...
      },
      {
        ...
        techStack: ["HTML", "CSS", "JavaScript"],
        description:
          "A todo list app built using HTML, CSS, and JavaScript. It allows users to add and delete todos.",
